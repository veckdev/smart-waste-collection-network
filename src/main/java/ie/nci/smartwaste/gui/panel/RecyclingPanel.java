...
public class RecyclingPanel extends JPanel {
    ...
    public RecyclingPanel() {
        ...
        JLabel title = new JLabel("Recycling Centre Service");
        title.setFont(GuiStyles.TITLE_FONT);
        title.setForeground(GuiStyles.TEXT_PRIMARY);
        title.setAlignmentX(Component.LEFT_ALIGNMENT);

        JLabel description = new JLabel(
                "<html>Receive waste deliveries, check centre capacity, " +
                        "process waste and upload batches using client streaming.</html>"
        );
